...
What surprised me was how much of building OnePage turned out to be product thinking wearing a different hat. Deciding what "done" meant for a task. Deciding how forgiving the interface should be when someone typed something ambiguous. Those were product decisions I was already equipped to make. The code around them was the part I had to learn, usually by getting it wrong first.
